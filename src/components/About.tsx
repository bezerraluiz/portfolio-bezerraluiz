...
const About = () => {
  ...
  const techStack = [
    { category: "Frontend", techs: ["React", "TypeScript", "Next.js", "Tailwind CSS"], icon: "🎨" },
    { category: "Backend", techs: ["Node.js", "Java", "Spring Boot", "Express"], icon: "⚙️" },
    { category: "Database", techs: ["PostgreSQL", "MongoDB", "Redis", "Prisma"], icon: "🗄️" },
    { category: "DevOps", techs: ["Docker", "AWS", "CI/CD", "Git"], icon: "🚀" }
  ];
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-1 gap-3">
                  {skills.map((skill, index) => (
                    <div key={index} className="flex items-center space-x-3 p-2 rounded-lg hover:bg-primary/5 transition-colors">
                  ...
                  <Card key={index} className="border-primary/20 hover:border-primary/40 transition-all hover:shadow-lg">
                    <CardContent className="p-6">
                      <div className="flex items-center mb-4">
                        ...
                        <h4 className="font-semibold text-primary text-lg">{stack.category}</h4>
                      </div>
